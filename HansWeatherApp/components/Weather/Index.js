...
const App = ({ route, navigation }) => {
  ...
  const [postalCode, setPostalCode] = useState("40214");
  const [lat, setLat] = useState(-6.914744);
  const [long, setLong] = useState(107.609810);
  ...
  return (
    <Container>
      <ImageBackground source={bgImg} style={{ width: "100%", height: "100%" }}>
        ...
        />
        <CurrentForecast currentWeather={weather} timezone={weather.timezone} name={name} />
